...
"[project]/app/(marketing)/artists/artists-client.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ArtistsClient({ artists, songs }) {
    ...
    const playArtistTrack = (artist)=>{
        ...
        if (artistSongs.length > 0) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(`No tracks found for ${artist.name}`);
        }
    };
...
//# sourceMappingURL=_03de3d0d._.js.map